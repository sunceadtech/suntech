  ...
  const services = [
    {
      ...
      description:
        "Keep your website running smoothly with regular updates, backups, and monitoring.",
      features: [
        "Security Patches",
    ...
    },
    {
      ...
      description:
        "Ensure your site is always accessible with robust hosting and uptime monitoring.",
      features: [
        "99.9% Uptime",
        "Server Monitoring",
        "Fast Load Times",
    ...
    },
    {
      ...
      description:
        "Rapid response team for website issues, downtime, or urgent fixes.",
      features: [
        "24/7 Monitoring",
        "Quick Response",
        "Issue Resolution",
  ...
  const processSteps = [
    {
      step: "01",
      title: "Assessment",
      desc: "Review current website health",
      icon: <Layers className="w-6 h-6" />,
    },
    {
      step: "02",
      title: "Implementation",
      desc: "Apply updates and security patches",
      icon: <Wrench className="w-6 h-6" />,
    },
    {
      step: "03",
      title: "Monitoring",
      desc: "Continuous monitoring and backups",
      icon: <Shield className="w-6 h-6" />,
    },
    {
      step: "04",
      title: "Support",
      desc: "Ongoing assistance for any issues",
    ...
    <>
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white overflow-hidden">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Link
                ...
                aria-label="Request website maintenance service"
              ...
              <Link
                ...
                aria-label="View detailed case studies of past projects"
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
            {services.map((service, index) => (
              <div
                key={index}
                className={`group relative p-8 bg-gradient-to-br from-purple-900/30 to-blue-900/30 rounded-2xl border border-purple-500/30 hover:border-purple-400/50 backdrop-blur-sm cursor-pointer transform transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl hover:shadow-purple-500/20 ${
                  activeService === index ? "ring-2 ring-purple-400/50" : ""
                }`}
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-black/20 backdrop-blur-sm">
          <div className="max-w-7xl mx-auto text-center mb-16">
            <h2 className="text-4xl sm:text-5xl font-bold py-4  mb-6 bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {technologies.map((tech, index) => (
              <div
                key={index}
                className={`px-6 py-3 bg-gradient-to-r from-purple-800/40 to-blue-800/40 rounded-full border border-purple-400/30 backdrop-blur-sm hover:border-purple-400/60 hover:scale-105 transition-all duration-300 cursor-pointer transform delay-${
                  index * 50
                }`}
              >
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              A simple and effective process to maintain and secure your website
            </p>
          </div>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-purple-900/50 to-blue-900/50 backdrop-blur-sm">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Get in touch for tailored maintenance and security services
            </p>
