  ...
  const services = [
    {
      ...
      description:
        "Tailored solutions built from scratch to meet your unique business requirements.",
      features: [
        "Custom Coding",
    ...
    },
    {
      ...
      description:
        "Lightning-fast loading speeds and optimized user experience.",
        ...
        <div className="relative max-w-7xl mx-auto">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
              <Link
                to="/contact"
                className="group bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 px-8 py-4 rounded-full font-semibold text-lg transition-all duration-300 transform hover:scale-105 hover:shadow-2xl"
                aria-label="Start your project by contacting our team"
              ...
              <Link
                to="/portfolio"
                className="group border-2 border-purple-400 hover:bg-purple-400/20 px-8 py-4 rounded-full font-semibold text-lg transition-all duration-300 transform hover:scale-105"
                aria-label="View our project portfolio showcasing past work"
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {technologies.map((tech, index) => (
              ...
              >
                <div
                  className={`w-16 h-16 ${tech.color} rounded-full mx-auto mb-4 flex items-center justify-center text-white font-bold text-lg transform group-hover:rotate-12 transition-transform duration-300`}
                >
                  {tech.name.charAt(0)}
                </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-12 max-w-2xl mx-auto">
            Let's discuss your vision and create something amazing together. Get
            in touch for a free consultation.
          </p>
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            <Link
              to="/contact"
              className="group bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 px-10 py-4 rounded-full font-semibold text-lg transition-all duration-300 transform hover:scale-105 hover:shadow-2xl"
            ...
            <a
              ...
              className="group border-2 border-purple-400 hover:bg-purple-400/20 px-10 py-4 rounded-full font-semibold text-lg transition-all duration-300 transform hover:scale-105"
              aria-label="Call us to schedule a consultation"
              title="Schedule a Call at +91 98735 69000"
            >
              Schedule Call
              <ChevronRight className="inline-block ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform" />
            </a>
