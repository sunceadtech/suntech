...
const DigitalMarketingBlog = () => {
  ...
  const blogPosts = [
    ...
    },
    {
      ...
      image: "https://www.kingofdigitalmarketing.com/blog/img/Facebook%20Ads%20vs.%20Google%20Ads.jpeg",
      category: "ppc",
  ...
  <section className="relative pt-20 pb-16 px-4 sm:px-6 lg:px-8 overflow-hidden bg-[aliceblue]">
    <div className="relative max-w-7xl mx-auto">
      <div className={`text-center transform transition-all duration-1000 mt-6 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
        ...
        <div className="inline-flex items-center bg-red-600 rounded-full px-6 py-2 mb-8">
          <Megaphone className="w-5 h-5 mr-2 text-white" />
          <span className="text-white font-medium">Digital Marketing Insights</span>
        </div>

        <h1 className="text-4xl py-4 sm:text-5xl lg:text-6xl font-bold mb-6 text-gray-900">
          Marketing Blog
        </h1>
      ...
      <section className="py-12 px-4 sm:px-6 lg:px-8 bg-[white]">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="relative overflow-hidden rounded-3xl border border-[black]">
            <div
              ...
              {categories.map((category) => (
                <button
                  ...
                  className={`flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium transition-all duration-300 transform hover:scale-105 ${selectedCategory === category.id
                    ...
                    : 'bg-white border border-[darkblue]/30 text-[darkblue] hover:bg-[aliceblue]'
                    }`}
                >
                  {category.icon}
                  {category.name}
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-[white]">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mt-12">
            <button className="group bg-gradient-to-r from-[orange] to-[darkblue] hover:from-[darkblue] hover:to-[orange] px-8 py-4 rounded-full font-semibold text-lg transition-all duration-300 transform hover:scale-105 hover:shadow-xl text-[white]">
              Load More Articles
              <ChevronDown className="inline-block ml-2 w-5 h-5 group-hover:translate-y-1 transition-transform duration-200" />
            </button>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-8">
            ...
            <h2 className="text-3xl sm:text-4xl py-4 font-bold mb-4">
              Stay Updated
            </h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
            <Link to='/contact' className='mx-auto cursor-pointer'><button className="bg-gradient-to-r from-[orange] to-[darkblue] hover:from-[darkblue] hover:to-[orange] px-8 py-4 rounded-md font-semibold mx-auto transition-all duration-300 transform hover:scale-105 hover:shadow-xl whitespace-nowrap text-[white] cursor-pointer">
              Know More
            </button>
            </Link>
          </div>
