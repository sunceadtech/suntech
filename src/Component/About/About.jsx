...
const AboutPage = () => {
  ...
  const values = [
    ...
    },
    {
      ...
      description:
        "Staying ahead of digital trends to deliver cutting-edge marketing solutions for our clients.",
    ...
    },
    {
      ...
      title: "Transparency",
      description:
        "Clear communication, honest reporting, and full visibility into all marketing activities.",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mt-6">
          <div>
            ...
            <p className="text-xl sm:text-2xl text-gray-700 mb-8 leading-relaxed">
              We're not just another marketing agency. We're growth partners who
              combine creativity with data-driven strategies to deliver
              exceptional results.
            </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              <div
                key={index}
                className="text-center transform hover:scale-105"
              >
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value, index) => (
              <div
                key={index}
                className={`p-8 rounded-2xl border border-orange-300 hover:scale-105 transition transform cursor-pointer ${
                  activeValue === index ? "ring-2 ring-orange-400" : ""
                }`}
                onClick={() => setActiveValue(index)}
              >
                <div
                  className={`w-16 h-16 bg-gradient-to-r ${value.color} rounded-xl flex items-center justify-center text-white mb-6`}
                >
                  {value.icon}
                </div>
            ...
            >
              ...
              <div className="aspect-w-16 aspect-h-9">
                <iframe
                  width="560"
                  height="315"
                  src="https://www.youtube.com/embed/QsY8fnvMn6c?si=B9qWRl7KQo4JHl3B"
