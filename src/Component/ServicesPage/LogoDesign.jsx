...
export default function LogoDesign() {
  ...
  return (
   ...
   <Helmet>
        ...
        <meta
          name="description"
          content="Stand out with custom logo design services by SunceADTECH. We create impactful, memorable brand logos tailored to your business identity."
        />
        <meta
          name="keywords"
      ...
      <div className="min-h-screen bg-gradient-to-br from-pink-900 via-purple-900 to-indigo-900 text-white overflow-hidden">
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto text-center mb-16">
            <p className="text-4xl font-bold mb-4 bg-gradient-to-r from-white via-pink-200 to-purple-200 bg-clip-text text-transparent">
              Client Testimonials
            </p>
            <p className="text-lg text-gray-300">
