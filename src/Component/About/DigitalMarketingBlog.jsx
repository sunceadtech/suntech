  ...
  const blogPosts = [
    {
      ...
      excerpt:
        "Avoid these common SEO pitfalls that could be hurting your search visibility.",
    ...
    },
    {
      ...
      excerpt:
        "A comprehensive comparison of two major short-form video platforms.",
    ...
    },
    {
      ...
      excerpt:
        "Detailed analysis of which platform delivers better returns for your ad spend.",
    ...
    },
    {
      ...
      excerpt:
        "Set up effective email sequences that convert prospects into customers.",
    ...
    },
    {
      ...
      excerpt:
        "Complete guide to transitioning from Universal Analytics to GA4.",
    ...
    },
    {
      ...
      excerpt:
        "Learn the key metrics and KPIs that matter for content marketing.",
      image:
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-center justify-between mt-4 pt-4 border-t border-[darkblue]/20">
                      <div className="flex items-center gap-4 text-sm text-[darkblue]">
                        <button
                          type="button"
                          className="flex items-center gap-1 hover:text-[orange] transition-colors duration-200"
                          aria-label={`This post has ${post.likes} likes`}
                          title={`This post has ${post.likes} likes`}
                        >
                        ...
                        <button
                          type="button"
                          className="flex items-center gap-1 hover:text-[orange] transition-colors duration-200"
                          aria-label={`View ${post.comments} comments on this post`}
                          title={`View ${post.comments} comments on this post`}
                        >
