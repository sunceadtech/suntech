...
const HeroSection = () => {
  ...
  const features = [
    ...
    { icon: "⚡", title: "Fast Results", desc: "Quick implementation" },
    {
      ...
      desc: "Attract and convert potential clients",
    },
  ];
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-lg sm:text-xl text-gray-600 max-w-xl leading-relaxed">
                ...
                that increase visibility, engage audiences, and drive measurable
                success. Accelerate Your Business Growth with Digital Power
              </p>
            </div>
          ...
          <div className="hidden lg:block">
            <div className="w-full h-96 rounded-2xl bg-white border border-gray-200 flex flex-col items-start justify-start text-gray-800 p-8 space-y-4 shadow-lg mt-[-40px]">
              ...
              <ul className="list-disc text-left list-inside text-sm text-gray-600 space-y-1">
