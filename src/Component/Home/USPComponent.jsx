  ...
  const uspCards = [
    {
      ...
      description:
        "Our proven strategies deliver measurable results within the first month. No waiting, no excuses.",
    ...
    },
    {
      ...
      description:
        "Advanced AI-powered targeting ensures your message reaches exactly who needs to hear it.",
    ...
    },
    {
      ...
      description:
        "White-glove service with dedicated account managers and custom-built strategies for your brand.",
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
            <span className="block">Award-Winning Digital Marketing</span>
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            ...
            with our proven methodology and cutting-edge strategies.We Don't
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center mb-12 sm:mb-16 lg:mb-20 px-4 sm:px-6 lg:px-0">
          ...
          <div
            className={`relative transition-all duration-1000 delay-300 order-2 lg:order-1 ${
              isVisible
              ...
              {uspCards.map((card, index) => (
                ...
                >
                  <div className="bg-white rounded-2xl sm:rounded-3xl shadow-xl sm:shadow-2xl overflow-hidden transform hover:scale-105 transition-all duration-500 mx-auto max-w-lg lg:max-w-none">
                    {/* Card Header */}
                    <div
                      className={`relative h-48 sm:h-56 lg:h-64 bg-gradient-to-br ${card.color} p-4 sm:p-6 lg:p-8 text-white`}
                    >
                      <div className="absolute inset-0 opacity-20">
                        <img
                          src={card.image}
                          alt="Best Marketing Agency In Delhi NCR"
                    ...
                    <div className="p-4 sm:p-6 lg:p-8">
                      ...
                      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 sm:gap-0">
                        <Link
                          to="/contact"
                          className={`w-full sm:w-auto px-4 sm:px-6 py-2.5 sm:py-3 bg-gradient-to-r ${card.color} text-white font-semibold rounded-lg sm:rounded-xl hover:shadow-lg transform hover:scale-105 transition-all duration-300 text-sm sm:text-base`}
                        >
                          Delhi NCR’s Most Trusted Digital Marketing Company
                        </Link>
          ...
          {/* Features List */}
          <div
            className={`space-y-6 sm:space-y-8 transition-all duration-1000 delay-500 order-1 lg:order-2 ${
              isVisible
                ? "opacity-100 translate-x-0"
                : "opacity-0 translate-x-10"
            }`}
          >
            <div className="space-y-4 sm:space-y-6">
              ...
              {mainFeatures.map((feature, index) => (
                <div
                  ...
                  className={`flex items-start space-x-3 sm:space-x-4 p-4 sm:p-6 rounded-xl sm:rounded-2xl transition-all duration-300 cursor-pointer ${
                    hoveredCard === index
                ...
                >
                  <div
                    className={`flex-shrink-0 w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 rounded-lg sm:rounded-xl flex items-center justify-center text-lg sm:text-xl lg:text-2xl transition-all duration-300 ${
                      hoveredCard === index
            ...
            <div className="bg-gradient-to-br from-orange-500 via-red-500 to-blue-900 rounded-2xl sm:rounded-3xl p-6 sm:p-8 text-white relative overflow-hidden">
              ...
              <div className="relative z-10">
                <p className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4 text-center sm:text-left">
                ...
                <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                  <Link
                    to="/blog"
                    className="w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 bg-white text-blue-600 font-bold rounded-lg sm:rounded-xl hover:bg-gray-100 transform hover:scale-105 transition-all duration-300 shadow-lg text-sm sm:text-base"
                  >
                    Explore our Service
                  </Link>
        ...
        >
          <div className="bg-white/90 backdrop-blur-md rounded-2xl p-8 border border-gray-200 shadow-lg">
            ...
            >
              ...
              >
                <span className="text-white font-bold">Web Designing</span>
              </motion.div>
...
{
  /*Why We’re the Best Digital Marketing Agency in Delhi NCR

Top Digital Marketing Services in Delhi NCR You Can Trust

Leading Digital Marketing Experts in Delhi NCR

Delhi NCR’s Most Trusted Digital Marketing Agency

Your Go-To Digital Marketing Partner in Delhi NCR

Affordable & Result-Driven Digital Marketing in Delhi NCR

Grow Your Business with the Best Digital Marketing Agency in Delhi NCR

Award-Winning Digital Marketing Services in Delhi NCR

Experience the Power of Digital with Delhi NCR’s Best Agency

Why Businesses Choose Us as Their Digital Marketing Agency in Delhi NCR */
}
