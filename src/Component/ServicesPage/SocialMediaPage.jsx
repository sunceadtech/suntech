          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                ...
                engine. We create engaging content, build communities, and drive
                real business results across all major platforms.
              </p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              ...
              All packages include dedicated support and regular performance
              reviews.
            </p>
          </div>
      ...
      <div className="py-16 px-4 bg-gradient-to-br from-pink-600 to-purple-600">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-pink-100 mb-8 max-w-2xl mx-auto">
            ...
            your business. Get started with a free consultation and social media
            audit.
          </p>
