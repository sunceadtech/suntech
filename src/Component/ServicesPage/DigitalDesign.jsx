...
import { Play, Film, Camera, Monitor, ArrowRight } from "lucide-react";
      ...
      <div className="min-h-screen bg-gradient-to-br from-pink-900 via-purple-900 to-indigo-900 text-white overflow-hidden">
        ...
        <section className="relative pt-32 pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
          <div className="max-w-7xl mx-auto relative z-10 text-center">
            ...
            <p className="text-xl sm:text-2xl text-gray-300 mb-10 max-w-3xl mx-auto">
              Bring your ideas to life with stunning video content that engages,
              inspires, and drives results.
            </p>

            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                to="/contact"
                aria-label="Start your video project by contacting us"
              ...
              <Link
                to="/portfolio"
                aria-label="View our video production portfolio"
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-black/20 backdrop-blur">
          <div className="max-w-7xl mx-auto text-center mb-16">
            ...
            <p className="text-lg text-gray-300">
              From concept to screen, we create impactful video content tailored
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto text-center mb-16">
            ...
            <p className="text-lg text-gray-300">
              Hear from clients who transformed their brand with our video
              content expertise.
            </p>
          </div>
