...
const PPCAdvertisingPage = () => {
  ...
  const services = [
    {
      ...
      description:
        "Custom PPC strategies tailored to your business goals and target audience",
      icon: "🎯",
      features: [
        "Keyword Research",
        "Competitor Analysis",
    ...
    },
    {
      ...
      description:
        "Compelling ad copy and creative that converts viewers into customers",
      icon: "🎨",
      features: [
        "Ad Copywriting",
        "Creative Design",
    ...
    },
    {
      ...
      description:
        "Ongoing optimization to maximize ROI and minimize wasted ad spend",
      icon: "⚙️",
      features: [
        "Bid Management",
        "Budget Optimization",
    ...
    },
    {
      ...
      description:
        "Detailed insights and transparent reporting on campaign performance",
      icon: "📊",
      features: [
        "ROI Tracking",
        "Conversion Analysis",
  ...
  const metrics = [
    { label: "Average ROAS", value: "4.2x", description: "Return on Ad Spend" },
    {
      ...
      value: "35%",
      description: "Lower CPC vs Industry",
    },
    {
  ...
  const testimonials = [
    {
      ...
      content:
        "Our PPC campaigns have generated over 2M in revenue with a 5.2x ROAS. The team's expertise in Google Ads and Facebook advertising is unmatched.",
      rating: 5,
    },
    {
      name: "Michael Chen",
      ...
      role: "CEO",
      content:
        "They transformed our struggling ad campaigns into profitable growth engines. Our conversion rate improved by 180% in just 3 months.",
      rating: 5,
    },
    {
      ...
      role: "CMO",
      content:
        "Professional, data-driven approach that delivers results. Our cost per acquisition dropped by 40% while scaling our campaigns 3x.",
      rating: 5,
    },
  ];
  ...
  const caseStudy = {
    ...
    solution:
      "Multi-platform PPC strategy with advanced targeting and landing page optimization",
    duration: "6 months",
    results: [
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
        {/* Hero Section */}
        <div
          className={`pt-20 sm:pt-28 lg:pt-32 pb-12 sm:pb-16 lg:pb-20 px-4 sm:px-6 lg:px-8 transform transition-all duration-1000 ${
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
              <div className="order-2 lg:order-1">
                ...
                <p className="text-lg sm:text-xl text-gray-600 mb-6 sm:mb-8 leading-relaxed">
                  Get immediate visibility and qualified leads with expertly
                  managed PPC campaigns. We optimize your ad spend across
                  Google, Facebook, LinkedIn, and more to deliver measurable
                  results.
                </p>
                ...
                {platforms.map((platform, index) => (
                  <div
                    ...
                    className={`bg-gradient-to-br ${
                      platform.color
                    } rounded-xl sm:rounded-2xl p-4 sm:p-6 text-white transform hover:scale-105 transition-all duration-300 shadow-xl hover:shadow-2xl cursor-pointer ${
                  ...
                  >
                    ...
                    <div
                      className={`space-y-1 text-xs sm:text-sm opacity-90 transition-all duration-300 ${
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12 sm:mb-16">
              ...
              <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto">
                From strategy to execution, we handle every aspect of your PPC
                campaigns to maximize your return on investment.
              </p>
            </div>
                  ...
                  <div className="space-y-3 sm:space-y-4 mb-6 sm:mb-8">
                    {pkg.features.map((feature, featureIndex) => (
                      <div key={featureIndex} className="flex items-start">
                        <div
                          className={`w-1.5 h-1.5 sm:w-2 sm:h-2 rounded-full mt-2 mr-3 flex-shrink-0 ${
