        ...
        <div className="container mx-auto mt-6 px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-white/80 mb-12 max-w-3xl mx-auto animate-slide-up delay-200">
              ...
              comprehensive analytics suite. Track, measure, and optimize your
              digital marketing performance in real-time.
            </p>
              ...
              <table className="w-full">
                <thead>
                  <tr className="text-left border-b border-white/20">
                    ...
                    <th className="text-white/70 pb-4 font-medium">
                      Impressions
                    </th>
            ...
            {[
              {
                ...
                description:
                  "Monitor your campaigns and website performance in real-time with live data updates and instant notifications.",
              },
              {
                icon: Target,
                title: "Conversion Optimization",
                description:
                  "Identify high-performing elements and optimize conversion funnels with advanced attribution modeling.",
              },
              {
                icon: Globe,
                title: "Multi-channel Analytics",
                description:
                  "Track performance across all digital channels from social media to email marketing in one unified dashboard.",
              },
              {
                icon: Users,
                title: "Audience Insights",
                description:
                  "Deep dive into user behavior, demographics, and journey mapping to better understand your customers.",
              },
              {
                icon: Zap,
                title: "Automated Reports",
                description:
                  "Schedule and customize automated reports delivered to stakeholders with key metrics and insights.",
              },
              {
                icon: Award,
                title: "Custom Dashboards",
                description:
                  "Create personalized dashboards with drag-and-drop widgets tailored to your specific business needs.",
              },
            ].map((feature, index) => (
              <div
                key={index}
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center bg-gradient-to-r from-blue-600/20 to-purple-600/20 backdrop-blur-sm rounded-2xl p-12 border border-white/10">
            ...
            <p className="text-xl text-white/80 mb-8 max-w-2xl mx-auto">
              ...
              analytics platform. Get insights that drive real business growth.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              {/* Anchor-like navigation with aria-label for screen readers */}
              <Link
                to="/contact"
                className="px-8 py-4 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-lg font-semibold hover:from-blue-600 hover:to-purple-700 transform hover:scale-105 transition-all duration-300 shadow-2xl"
                aria-label="Start your free trial by contacting us"
              >
                Start Free Trial
              </Link>

              {/* Changed to <a> tag with a meaningful link and aria-label */}
              <a
                href="/contact"
                className="px-8 py-4 bg-white/10 backdrop-blur-sm text-white rounded-lg font-semibold hover:bg-white/20 transition-all duration-300 border border-white/20"
                aria-label="Book a consultation session with our team"
              >
                Book a Consultation
              </a>
            </div>
