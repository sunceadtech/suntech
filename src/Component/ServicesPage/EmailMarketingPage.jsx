...
const EmailMarketingPage = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      detail:
        "Track opens, clicks, conversions, and ROI with detailed visual reports",
    },
    {
      ...
      detail:
        "Create sophisticated drip campaigns with conditional logic and triggers",
    },
    {
      ...
      detail:
        "Advanced spam testing, domain authentication, and reputation management",
    },
  ];
  ...
  return (
    <>
      <Helmet>
        <title>Digital Strategy Consultant | Sunceadtech</title>
        <meta
          name="description"
          content="Partner with Sunceadtech's digital strategy consultants to craft tailored, data-driven marketing strategies that drive real business growth."
        />
        <meta
          name="keywords"
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            <div className="text-center">
              ...
              <p className="text-xl sm:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto leading-relaxed">
                Create stunning email campaigns, automate your marketing, and
                turn subscribers into loyal customers with our powerful
                platform.
              </p>
              ...
              {stats.map((stat, index) => (
                ...
                >
                  <div className="mb-4 flex justify-center">
                    <div
                      className={`p-4 bg-gradient-to-br ${stat.color} bg-opacity-20 rounded-xl group-hover:bg-opacity-30 transition-all duration-300`}
                    >
                  ...
                  >
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        {activeFeature === index && (
                          <p className="text-blue-300 text-sm animate-fade-in">
                            {feature.detail}
                          </p>
                        )}
                      </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="w-full bg-gray-700 rounded-full h-2">
                        <div
                          className="bg-gradient-to-r from-green-400 to-blue-400 h-2 rounded-full animate-progress"
                          style={{ width: "89.5%" }}
                        ></div>
                      </div>
                      ...
                      <div className="w-full bg-gray-700 rounded-full h-2">
                        <div
                          className="bg-gradient-to-r from-purple-400 to-pink-400 h-2 rounded-full animate-progress-delayed"
                          style={{ width: "34.2%" }}
                        ></div>
                      </div>
                      ...
                      <div className="w-full bg-gray-700 rounded-full h-2">
                        <div
                          className="bg-gradient-to-r from-orange-400 to-red-400 h-2 rounded-full animate-progress-slow"
                          style={{ width: "12.8%" }}
                        ></div>
                      </div>
                    </div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="mb-8">
              ...
              <p className="text-xl text-gray-300 mb-8 leading-relaxed">
                Join thousands of businesses already growing their revenue with
                our powerful Digital Strategy Consultant platform.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
              <Link
                to="/contact"
                className="px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 rounded-full font-semibold text-lg transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-blue-500/25 group"
              >
                <span className="flex items-center justify-center gap-2">
                  Start Free Trial
                  <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform duration-300" />
