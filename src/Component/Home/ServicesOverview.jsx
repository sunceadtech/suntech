  ...
  const services = [
    {
      ...
      description:
        "Dominate search results with our advanced SEO strategies. Get found by customers actively searching for your services.",
    ...
    },
    {
      ...
      description:
        "Create engaging content and build a loyal following across all major social platforms with our proven strategies.",
    ...
    },
    {
      ...
      description:
        "Compelling content that educates, engages, and converts your audience into loyal customers and brand advocates.",
    ...
    },
    {
      ...
      description:
        "Captivate your audience with high-quality video content that boosts brand awareness, engagement, and conversions across all platforms.",
...

    {
      ...
      description:
        "Comprehensive analytics and detailed reporting to track performance and optimize every aspect of your campaigns.",
      image:
    ...
    },
    {
      ...
      description:
        "Custom websites built to engage users, perform flawlessly, and scale with your business needs.",
    ...
    },
    {
      ...
      description:
        "High-performance mobile apps tailored for your brand to deliver exceptional user experiences.",
    ...
    },
    {
      ...
      description:
        "We build scalable and secure software products that solve real-world problems and drive business success.",
      image:
        "https://media.istockphoto.com/id/2158910512/photo/programming-or-developing-a-software-or-game-application-program-or-code-development-on-3d.webp?a=1&b=1&s=612x612&w=0&k=20&c=Q2p_1OvMxJnlgKq7c0S505mXhFM-FjiBY41Blort0mY=",
      features: [
        "Custom Applications",
        "API Integration",
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className={getAnimationClass("text-center mb-20")}>
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
            <span className="pb-4 block text-black/90">
              Experience the Power of Digital with Delhi{" "}
              <span className="bg-gradient-to-br from-orange-500 via-red-500 to-blue-900 bg-clip-text text-transparent">
                NCR’s Best Agency
              </span>
            </span>
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            ...
            services designed to grow your business and maximize your online
            presence.
          </p>
        </div>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {processSteps.map((step, index) => (
              <div
                ...
                style={
                  !isMobile ? { transitionDelay: `${800 + index * 200}ms` } : {}
                }
              >
        ...
        <div className={getAnimationClass("text-center mt-16 delay-700")}>
          <div className="bg-gradient-to-br from-orange-500 via-red-500 to-blue-900 rounded-3xl p-8 lg:p-12 text-white relative overflow-hidden">
            ...
            <p className="text-xl mb-8 opacity-90 max-w-2xl mx-auto">
              Join 500+ successful businesses who've already accelerated their
