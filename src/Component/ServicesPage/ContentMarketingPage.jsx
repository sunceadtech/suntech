...
const ContentMarketingPage = () => {
  ...
  const services = [
    {
      ...
      desc: "Comprehensive content strategies that align with your business goals",
    },
    {
      icon: <TrendingUp className="w-8 h-8" />,
      title: "Content Creation",
      desc: "High-quality, engaging content across all formats and platforms",
    },
    {
      icon: <Users className="w-8 h-8" />,
      title: "Audience Engagement",
      desc: "Build meaningful connections with your target audience",
    },
    {
      icon: <Zap className="w-8 h-8" />,
      title: "Performance Analytics",
      desc: "Data-driven insights to optimize your content performance",
    },
  ];
  ...
  const testimonials = [
    {
      name: "Sarah Johnson",
      company: "TechCorp",
      text: "Their content strategy transformed our brand presence completely.",
      rating: 5,
    },
    {
      name: "Mike Chen",
      company: "StartupX",
      text: "ROI increased by 400% within just 6 months of working with them.",
      rating: 5,
    },
    {
      name: "Emma Davis",
  ...
  return (
    <>
      <Helmet>
        <title>Content Marketing Services | Sunceadtech</title>
        <meta
          name="description"
          content="Boost your brand visibility and audience engagement with Sunceadtech's #1 content marketing services. Explore our strategy-driven content solutions today."
        />
        <meta
          name="keywords"
        ...
        <section className="relative pt-32 pb-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl sm:text-2xl text-gray-300 mb-12 max-w-3xl mx-auto leading-relaxed">
              We create compelling content strategies that drive engagement,
              build communities, and deliver measurable results for your
              business.
            </p>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-purple-600/20 to-pink-600/20">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              Join hundreds of successful brands who've revolutionized their
              marketing with our proven content strategies.
            </p>
